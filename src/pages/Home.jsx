...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <br />
      <br />
      <h3> Our app allows you to search a database of beers to find the one that suits you - without the headache.  Whether it’s a specific type or brewery you are looking for, we make it easy to pick your new best suds.  If it’s love at first sip you can add it to your personalized, editable list and be prepared for the next time when you feel on the precipice of ...beerception.</h3>
